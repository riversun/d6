...
public class TestHelper_TestDBGen {
    ...
    public void createTestDB() {
        ...
        try {
            Class.forName(TestHelper_TestDBDef.JDBC_DRIVER);

            conn = DriverManager.getConnection(TestHelper_TestDBDef.DATABASE_URL, TestHelper_TestDBDef.USER, TestHelper_TestDBDef.PASS);
